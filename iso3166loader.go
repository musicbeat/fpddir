...
Extracted the table of "Officially assigned code elements" from
the wiki source, and munged extensively to convert to tab-
delimited data embedded in this source file.
*/
